...
public class FunkyFluidsMaterials {
	...
	public static final Material MELONADE_MATERIAL = new FunkyFluidsMaterials.Builder(MaterialColor.COLOR_RED).noCollider().notSolidBlocking().nonSolid().destroyOnPush().replaceable().liquid().build();
